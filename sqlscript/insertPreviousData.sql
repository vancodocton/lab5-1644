insert into Roles (Name, PathAcess) values ('Company Higher Manager', 'com');
...
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 1, 50, CURRENT_TIMESTAMP);
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 2, 50, CURRENT_TIMESTAMP);
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 3, 50, CURRENT_TIMESTAMP);
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 4, 50, CURRENT_TIMESTAMP);
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 5, 50, CURRENT_TIMESTAMP);
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 6, 50, CURRENT_TIMESTAMP);
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 7, 50, CURRENT_TIMESTAMP);
insert into StoreInventory (StoreId, ProductId, Quantity, Time) values (1, 8, 50, CURRENT_TIMESTAMP);
--rollback;