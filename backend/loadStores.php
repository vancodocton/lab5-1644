<?php
	...
	$query = "SELECT s.id, s.name, a.username FROM stores AS s INNER JOIN accounts AS a ON a.id = s.manageraccountid;";
		...
		<tbody>
			<?php foreach ($stocks as $stock) :?>
				<tr>
					...
					<td><?php echo htmlspecialchars($stock['username'])?></td>
					<td>null</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
